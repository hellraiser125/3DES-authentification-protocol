...
//}
//
//std::string xored_msg(const std::string& ep_msg, const std::string& fe_key) {
//	int xor_val;
//	size_t i;
//	size_t len = ep_msg.length();
//	char* holder = new char[len + 1];  // Add +1 for null-termination
//	std::string xored_msg;
//
//	for (i = 0; i < len; i++) {
...
//	}
//
//	holder[len] = '\0';  // Null-terminate the resulting array
//	xored_msg = holder;
//
//	delete[] holder;  // Deallocate the dynamically allocated array
//
//	return xored_msg;
//}
//
